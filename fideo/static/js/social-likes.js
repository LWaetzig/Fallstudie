...
document.addEventListener("DOMContentLoaded", function () {
  setTimeout(function () {
    (function () {
      function k(a, b, c) {
        for (var d = -1, e = !1; -1 != (d = a.className.indexOf(b, d + 1)); )
          (d && !/\s/.exec(a.className.charAt(d - 1))) ||
            (d != a.className.length - b.length &&
              !/\s/.exec(a.className.charAt(d + b.length))) ||
            ((e = !0),
            c &&
              (a.className =
                a.className.substr(0, d - 1) +
                a.className.substr(d + b.length)));
        return e;
      }
      function q(a, b, c) {
        ...
        d.onreadystatechange = function () {
          "complete" == d.readyState
            ? b && b()
            : "loaded" == d.readyState &&
              (d.children, "loading" == d.readyState && c && c());
      ...
      function x(a, b) {
        function c(d) {
          if ("keydown" !== d.type || 27 === d.which) {
            ...
            d != a &&
              (k(a, "mbr-social-likes_opened", !0),
              removeListener(document, "click", c),
              removeListener(document, "touchstart", c),
              removeListener(document, "keydown", c),
              b());
          }
        }
      ...
      function y(a) {
        if (document.documentElement.getBoundingClientRect) {
          ...
          10 > d.left
            ? (a.stype.left = 10 - d.left + b + "px")
            : d.right > window.innerWidth - 10 &&
              (a.style.left = window.innerWidth - d.right - 10 + b + "px");
          10 > d.top
            ? (a.style.top = 10 - d.top + c + "px")
            : d.bottom > window.innerHeight - 10 &&
              (a.style.top = window.innerHeight - d.bottom - 10 + c + "px");
        }
        ...
        p = {
          ...
          fetch: function (a, b, c) {
            ...
            if (c.forceUpdate || !d[b]) {
              ...
              for (f in c) e[f] = c[f];
              var g = { resolve: function (a) {}, reject: function () {} };
              if (
                (a = e.counterUrl && m(e.counterUrl, { url: b })) &&
                ...
                var h = function (a) {
                  try {
                    "function" == typeof e.convertNumber &&
                      (a = e.convertNumber(a)),
                      g.resolve(a);
                  } catch (z) {
                    g.reject();
      ...
      window.socialLikes = function (a, b) {
        ...
        if (c) "object" == typeof b && c.update(b);
          ...
          var d = v(a),
            e;
          for (e in window.socialLikes.defaults)
            c[e] = window.socialLikes.defaults[e];
          for (e in b) c[e] = b[e];
          for (e in d) c[e] = d[e];
          c = new t(a, c);
      ...
      h = (function () {
        for (
          ...
          d &&
            "og:" == d.substr(0, 3) &&
            (a[d.substr(3)] = b[c].getAttribute("content"));
        }
        return a;
      })();
      ...
      t.prototype = {
        init: function () {
          var a = this;
          k(this.container, "mbr-social-likes") ||
        ...
        initUserButtons: function () {
          if (!this.userButtonInited && window.socialLikesButtons)
            for (var a in window.socialLikesButtons) {
              l[a] = l[a] || {};
              for (var b in window.socialLikesButtons[a])
                l[a][b] = window.socialLikesButtons[a][b];
            }
        ...
        makeSingleButton: function () {
          if (this.single) {
            ...
            for (
              c.className = "mbr-social-likes__single-container";
              a.firstChild;
            ...
            addListener(d, "click", function () {
              k(d, "mbr-social-likes__widget_active", !0)
                ? k(a, "mbr-social-likes_opened", !0)
                : ((d.className += " mbr-social-likes__widget_active"),
                  (a.style.left = (d.offsetWidth - a.offsetWidth) / 2 + "px"),
        ...
        ready: function (a) {
          ...
          a ||
            ((a = this.container["on_ready.mbr-social-likes"]) &&
              a(this.number));
        },
        getCounterElem: function () {
          var a = this.widget.querySelector(
            ".mbr-social-likes__counter_single"
          );
          a.length ||
            ((a = document.createElement("span")),
            (a.className = n("counter", "single")),
      ...
      u.prototype = {
        ...
        update: function (a) {
          ...
          (a = this.widget.querySelector(".mbr-social-likes__counter")) &&
        ...
        detectService: function () {
          ...
          if (!a) {
            for (
              var b = this.widget.classList || this.widget.className.split(" "),
                c = 0;
              c < b.length;
              c++
            ) {
        ...
        detectParams: function () {
          ...
          if (a) {
            var b = parseInt(a, 10);
            isNaN(b)
              ? (this.options.counterUrl = a)
              : (this.options.counterNumber = b);
          }
          if ((a = this.widget.getAttribute("data-title")))
        ...
        initHtml: function () {
          ...
          c.className =
            c.className.replace(" " + this.service, "") +
            " " +
        ...
        cloneDataAttrs: function (a, b) {
          for (var c = 0; c < a.attributes.length; c++)
            "data-" == a.attributes[c].name.substr(0, 5) &&
              b.setAttribute(a.attributes[c].name, a.attributes[c].value);
        },
        ...
        updateCounter: function (a) {
          ...
          a || this.options.zeroes
            ? ((b.innerHTML = a),
              (b.className = this.getElementClassNames("counter")))
            : (b.className =
                this.getElementClassNames("counter") +
                " mbr-social-likes__counter_empty");
          this.widget.appendChild(b);
          (b = this.widget["on_counter.mbr-social-likes"]) &&
            b([this.service, a]);
        },
        click: function (a) {
          var b = this.options,
            c = !0;
          "function" == typeof b.click && (c = b.click.call(this, a));
          c &&
            ((a = m(b.popupUrl, {
              url: b.url,
              title: b.title,
            ...
            this.openPopup(a, { width: b.popupWidth, height: b.popupHeight }));
          return !1;
        },
        addAdditionalParamsToUrl: function (a) {
          ...
          var d = "";
          for (c in b)
            d += "&" + encodeURIComponent(c) + "=" + encodeURIComponent(b[c]);
          if (!d) return a;
        ...
        openPopup: function (a, b) {
          ...
          screen.height > b.height &&
            (d = Math.round(screen.height / 3 - b.height / 2));
          var e = window.open(
            a,
            "sl_" + this.service,
            "left=" +
          ...
          if (e) {
            e.focus();
            (a = this.widget["on_popup_opened.mbr-social-likes"]) &&
              a([this.service, e]);
            var f = this,
