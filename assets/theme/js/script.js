...
$jscomp.polyfill = function (b, k, d, q) {
  if (k) {
    d = $jscomp.global;
    b = b.split(".");
    ...
    return b
      ...
      : function (b, d, q) {
          ...
          if ("function" == typeof p) {
            b = p.call(b);
            for (var u = 0; !(p = b.next()).done; )
              k.push(d.call(q, p.value, u++));
          } else
            for (p = b.length, u = 0; u < p; u++) k.push(d.call(q, b[u], u));
          return k;
        };
  },
  "es6",
...
$jscomp.findInternal = function (b, k, d) {
  ...
  for (var q = b.length, m = 0; m < q; m++) {
    var p = b[m];
    if (k.call(d, p, m, b)) return { i: m, v: p };
  }
  return { i: -1, v: void 0 };
};
$jscomp.polyfill(
  ...
  function (b) {
    return b
      ...
      : function (b, d) {
          ...
          for (var u = 0; u < p && d < m; ) if (k[d++] != b[u++]) return !1;
          return u >= p;
        };
  },
  "es6",
  ...
  function G(a, c) {
    if (
      ...
      if (c.includes("Color"))
        ...
        var b = a.getAttribute("id") + "-svg-gradient";
        c = a.querySelector("." + c);
        var g = +c.getAttribute("data-goal");
        z(c, b, g);
      }
  }
  var h,
  ...
  m(function () {
      ...
      b(a, "[data-bg-video]").forEach(function (a) {
        ...
        if (b) {
          ...
          if (c && (/youtu\.?be/g.test(c[3]) || /vimeo/g.test(c[3])))
            ...
            var g = function () {
              var a = f.videoHeight,
                b = f.parentNode.clientHeight,
                c = f.parentNode.clientWidth;
              f.style.height = (a < b ? b : a) + "px";
              f.style.width = null;
              f.clientWidth < c &&
                ((f.style.width = "100%"), (f.style.height = null));
            };
    ...
    if ("undefined" !== typeof jarallax && !x()) {
      ...
      if (n) {
        ...
        h(document).on("changeParameter.cards", function (a, b, e, l) {
          if ("bg" === b)
            switch (
              ((b = a.target),
    ...
    if (v)
      h(document).on("add.cards delete.cards", function (a) {
        ...
        g = setTimeout(function () {
          ...
          a &&
            ((t = { breakPoint: k(a).top + 3 * d(a), fixed: !1, elm: a }),
    ...
    if (n)
      h(document).on("changeParameter.cards", function (a, b, c, l) {
        if ("bg" === b)
          switch (l) {
            case "type":
      ...
      var a = function (a) {
        ...
        b = function (b) {
          ...
          if (d) {
            ...
            var h = c.parentNode.querySelector("video");
            h && h.play && h.play();
          }
          var k = b.parents("section")[0],
            f = k.querySelector(
              k.querySelector("[data-modal]").getAttribute("data-modal")
            );
          ...
          f.addEventListener("click", function (b) {
            d
              ...
              : (b = c.parentNode.querySelector("video")) && b.stop && b.stop();
  ...
  if (n && v)
    h(document)
      .on("add.cards", function (a) {
        h(a.target).hasClass("testimonials-slider") && y(a.target);
      })
...
!(function () {
  ...
  if (!document.getElementById("top-1")) {
    ...
    a.style = "display: none";
    a.innerHTML =
      '<a href="https://mobirise.com/offline-website-builder.html">Offline Website Software</a> Mobirise v5.7.0 <a href="https://mobirise.com/offline-website-builder.html">Offline Website Creator</a>';
